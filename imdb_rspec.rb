...
class SeriesMaster
  ...
  def most_seasons_from(series_s) # array with strings
  ...
  def objectify_series(series_s)
    ...
    series_s.each do |serie|
      ...
      serie = Imdb::Serie.new(serie_id) # object serie
      series_o << serie
    end
...
describe SeriesMaster do
  ...
  describe "#most_seasons_from" do
    it "should return Friends" do
      ...
      # hash? how does imdb api return data?
    end
  ...
  #   it "should return ?" do # find case
  #     expect(@master.most_episodes_from()).to eq([])
  #     # hash? how does imdb api return data?
  #   end

  #   it "should return all series with max episodes" do
  #     expect(@master.most_episodes_from()).to eq([])
  #   end
  # end
