class Varys
  ...
  # Upon receiving a list of words, reverse them and return only the ones which have five letters or more
...
varys = Varys.new
puts varys.say_my_name!
puts varys.backwards_wording(["Hola", "Spiderman"])